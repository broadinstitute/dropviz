...
onRestored(function(state) {
  ...
  updateSelectizeInput(session, "user.genes", selected=state$input$user.genes, choices=c("Symbol"="", unique(c(state$input$user.genes, gene.symbols))), server=TRUE)
...
updateSelectizeInput(session, "user.genes", choices=c("Symbol"="", gene.symbols), server=TRUE)
