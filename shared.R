...
# if prep.dir default changed, then dockerfile must also be changed
prep.dir <- getOption('dropviz.prep.dir', default='/dropseq/staged')               # destination for all prepared data
